...
public class TextBox {
	...
	public TextBox() {
		super();
		String[][] str = {
				{ "Редагування", "Відкрити редагування не вдалося", "Відкрити редагування неможливо, через те, що не вибрано елемент!" },
				...
				{ "Увага!", "", "Назва або номер такий вже існує! Змініть назву або номер." },
				{ "Увага!", "", "Такого товару не існує." },
				{ "Увага!", "", "Зачекайте будь-ласка, поки відбувається оновлення товару ..." },
				{"Увага!", "", "Зв'язок з базою данних втрачений, зачекайте будь-ласка поки відбувається його повернення"}};
		String[][][] infoTmp = {
	...
	public static Optional<ButtonType> alertOpenDialog(AlertType type, String key, String str) {
		...
		Alert alert = new Alert(type);
		alert.setTitle(box.msg.get(key)[0]);
		alert.setHeaderText(box.msg.get(key)[2]);
