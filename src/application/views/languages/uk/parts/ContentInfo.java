    ...
    public ContentInfo() {
        ...
        columnsContent.put(
                ...
                FXCollections.observableArrayList(
                        ...
                        new String[]{"Integer", "№", "number"},
                        new String[]{"Integer", "Код товару", "code"},
                        new String[]{"Integer", "Номер кнопки", "id"},
                        new String[]{"String", "Назва", "name"},
                        new String[]{"String", "Тип", "full_name"},
                        new String[]{"String", "Ціна", "price"}));
        columnsContent.put(
                "sections",
                FXCollections.observableArrayList(
                        new String[]{"CheckBox", "", "checkBox"},
                        new String[]{"Integer", "№", "number"},
                        new String[]{"Integer", "Номер", "id"},
                        new String[]{"String", "Назва", "name"},
                        new String[]{"String", "З", "name_s"},
                        new String[]{"String", "До", "name_t"},
