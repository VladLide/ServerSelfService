...
public class TemplateInfo {
	...
	public static ObservableList<String[]> ItemsTemplate = FXCollections.observableArrayList(
			...
			new String[] { "ingredients", "Інгредієнти", "Інгредієнти ..." },
			new String[] { "tara", "Тара", "0.000" },
			new String[] { "weightUp", "Вага бутто", "00.000" },
			new String[] { "weightDown", "Вага нетто", "00.000" },
			...
			new String[] { "rectangle", "Прямокутник", "" },
			new String[] { "NB", "Номер кнопки товару", "1" });
