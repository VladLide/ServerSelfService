...
public class TextBox {
	...
	public TextBox() {
		...
		String[][] str = {
				...
				{ "Увага!", "", "Зачекайте будь-ласка, поки відбувається оновлення товару ..." }, { "Увага!", "",
						"Зв'язок з базою данних втрачений, зачекайте будь-ласка поки відбувається його повернення" } };
		String[][][] infoTmp = {
