...
public class Barcode {
    ...
    public Barcode(Codes barcode, int cod, String unit) {
    	super();
    ...
    public String generateCode() {
        ...
        System.out.println(result+Barcode.checkSum(result));
    	return result;
    }
    ...
    public void setParameters(double ModuleWidth, double BarHeight, double FontSize, double QuietZone,boolean doQuietZone) {
