...
public class OptionsItem implements Externalizable {
	...
	public void readExternal(ObjectInput in) {
		for (Field f : getClass().getDeclaredFields()) {
			...
			try {
				/*
				 * switch(Utils.getType(f)) { case "Integer":
				 */
				f.set(this, in.readObject());
				/*
				 * break; case "int": f.set(this,(int)in.readObject()); break; case "FontItem":
				 * f.set(this,(FontItem)in.readObject()); break; case "Double":
				 * f.set(this,(Double)in.readObject()); break; case "String":
				 * f.set(this,(String)in.readObject()); break; default:
				 * System.out.println(table+": type was not found " +
				 * f.getName()+":"+f.getType()); }
				 */
			} catch (Exception e) {
